...
public class Stone extends Block {
	...
	public Stone(Chunk chunk, int[] pos, int type, Byte renderFaces) {
		super(chunk, pos, type, renderFaces);
	}

	protected float[] generateVertices(Byte faces) {
		float originCornerx = 0f; //The x coordinate of the top texture on the bottom left corner of the image
